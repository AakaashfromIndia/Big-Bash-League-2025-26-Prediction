...
# Define team squads
squads = {
    'Adelaide Strikers': ["JL Barsby", "TT Beaumont", "D Brown", "S Ecclestone", "TM McGrath", "AC Mushangwe", "BE Patterson", "M Penna", "ML Schutt", "A Wellington", "L Wolvaardt"],
    'Brisbane Heat': ["Lily Bassingthwaighte", "Bonnie Berry", "Lucy Bourke", "N de Klerk", "SU Ginger", "LK Hamilton", "NM Hancock", "GM Harris", "O Henry", "JL Jonassen", "CR Knott", "JI Rodrigues", "GE Parsons", "G Redmayne" ],
    'Hobart Hurricanes': ["NJ Carey", "H Graham", "R Johnston", "L Lee", "NR Sciver-Brunt", "H Silver-holmes", "A Smith", "LG Smith", "Linsey Smith", "M Strano", "EJ Villani", "DN Wyatt" ],
    'Melbourne Renegades': ["A Capsey", "E de Broughe", "DJS Dottin", "T Flintoff", "MH Illingworth", "S Molineux", "NE Stalenberg", "G Wareham"],
    'Melbourne Stars': ["S Day", "KJ Garth", "ML Gibson", "E Hayward", "AE Jones", "M Kapp", "A Lanning", "R McKenna", "IY Mckeon", "G Prestwidge", "S Reid", "A Sutherland"],
    'Perth Scorchers': ["CC Ainsworth", "M Darke", "SFM Devine", "AL Edgar", "M Hinkley", "E Hoskin", "A King", "KM Mack", "L Mills", "BL Mooney", "P Scholfield", "CL Tryon"],
    'Sydney Sixers': ["C Bray", "M Brown", "L Cheatle", "SIR Dunkley", "A Gardner", "AJ Healy", "JL Hunter", "AC Kerr", "EA Perry", "CG Sippel", "M Villiers"],
    'Sydney Thunder': ["Chamari Athapaththu", "S Bates", "E Briscoe", "HJ Darlington", "S Eve", "H Gill", "L Harris", "S Ismail", "HC Knight", "A Learoyd", "P Litchfield", "T Peschel", "G Voll", "T Wilson"]
}


# Matches info
matches_info = [
    ("Nov 09", "Brisbane Heat", "Melbourne Renegades", "Allan Border Field, Brisbane"),
    ("Nov 09", "Sydney Thunder", "Hobart Hurricanes", "Allan Border Field, Brisbane"),
    ("Nov 09", "Perth Scorchers", "Sydney Sixers", "W.A.C.A. Ground"),
    ("Nov 10", "Melbourne Stars", "Adelaide Strikers", "Junction Oval, Melbourne"),
    ("Nov 11", "Melbourne Renegades", "Sydney Thunder", "Junction Oval, Melbourne"),
    ("Nov 12", "Brisbane Heat", "Perth Scorchers", "Allan Border Field, Brisbane"),
    ("Nov 13", "Sydney Sixers", "Hobart Hurricanes", "North Sydney Oval, Sydney"),
    ("Nov 14", "Perth Scorchers", "Melbourne Stars", "Karen Rolton Oval, Adelaide"),
    ("Nov 14", "Adelaide Strikers", "Melbourne Renegades", "Karen Rolton Oval, Adelaide"),
    ("Nov 15", "Hobart Hurricanes", "Brisbane Heat", "Drummoyne Oval, Sydney"),
    ("Nov 15", "Sydney Thunder", "Sydney Sixers", "Drummoyne Oval, Sydney"),
    ("Nov 16", "Adelaide Strikers", "Perth Scorchers", "Junction Oval, Melbourne"),
    ("Nov 16", "Melbourne Stars", "Melbourne Renegades", "Junction Oval, Melbourne"),
    ("Nov 18", "Hobart Hurricanes", "Adelaide Strikers", "Bellerive Oval, Hobart"),
    ("Nov 19", "Sydney Thunder", "Perth Scorchers", "Drummoyne Oval, Sydney"),
    ("Nov 20", "Hobart Hurricanes", "Melbourne Renegades", "North Sydney Oval, Sydney"),
    ("Nov 20", "Sydney Sixers", "Melbourne Stars", "North Sydney Oval, Sydney"),
    ("Nov 21", "Brisbane Heat", "Sydney Thunder", "Allan Border Field, Brisbane"),
    ("Nov 22", "Hobart Hurricanes", "Sydney Sixers", "Bellerive Oval, Hobart"),
    ("Nov 22", "Perth Scorchers", "Adelaide Strikers", "W.A.C.A. Ground"),
    ("Nov 23", "Sydney Thunder", "Melbourne Renegades", "Drummoyne Oval, Sydney"),
    ("Nov 23", "Brisbane Heat", "Melbourne Stars", "Allan Border Field, Brisbane"),
    ("Nov 25", "Adelaide Strikers", "Brisbane Heat", "Karen Rolton Oval, Adelaide"),
    ("Nov 26", "Melbourne Stars", "Hobart Hurricanes", "Junction Oval, Melbourne"),
    ("Nov 27", "Melbourne Renegades", "Perth Scorchers", "Junction Oval, Melbourne"),
    ("Nov 28", "Brisbane Heat", "Sydney Sixers", "Adelaide Oval"),
    ("Nov 28", "Adelaide Strikers", "Sydney Thunder", "Adelaide Oval"),
    ("Nov 29", "Melbourne Renegades", "Melbourne Stars", "Junction Oval, Melbourne"),
    ("Nov 29", "Hobart Hurricanes", "Perth Scorchers", "Bellerive Oval, Hobart"),
    ("Nov 30", "Adelaide Strikers", "Brisbane Heat", "North Sydney Oval, Sydney"),
    ("Nov 30", "Sydney Sixers", "Sydney Thunder", "North Sydney Oval, Sydney"),
    ("Dec 01", "Hobart Hurricanes", "Melbourne Stars", "Bellerive Oval, Hobart"),
    ("Dec 02", "Perth Scorchers", "Melbourne Renegades", "W.A.C.A. Ground"),
    ("Dec 03", "Sydney Sixers", "Melbourne Stars", "Drummoyne Oval, Sydney"),
    ("Dec 03", "Sydney Thunder", "Brisbane Heat", "Drummoyne Oval, Sydney"),
    ("Dec 05", "Melbourne Renegades", "Sydney Sixers", "Junction Oval, Melbourne"),
    ("Dec 05", "Adelaide Strikers", "Hobart Hurricanes", "Karen Rolton Oval, Adelaide"),
    ("Dec 06", "Perth Scorchers", "Brisbane Heat", "W.A.C.A. Ground"),
    ("Dec 07", "Melbourne Stars", "Sydney Thunder", "Junction Oval, Melbourne"),
    ("Dec 07", "Sydney Sixers", "Adelaide Strikers", "North Sydney Oval, Sydney"),
]
...
excel_filename = 'wbbl_winner_predictions.xlsx'
